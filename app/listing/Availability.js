...
export default class AgendaScreen extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      items: {},
  ...
  render() {
    ...
    return (
      ...
      <Agenda
        ...
        renderItem={(item, firstItemInDay) => {return (<CalenderItem data={item}/>);}}
        // renderItem={(item, firstItemInDay) => {return (<View />);}}
        //renderItem={ (item) => {
          
        //   if(item.schedule){
        //     // replace this with pure component 
        //     if(item.date){
        ...
        //               return (
        //               <TouchableOpacity key={i} onPress={ () =>{console.log("selected time ====", time, "on this date=", this.date)} }>
