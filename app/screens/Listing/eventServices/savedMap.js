...
// // import { getLocation, geocodeLocationByName, getGeoLocation } from '../../../services/location-service';
...
// //         }
// //       }, 10);
// //     //   setTimeout (() => {this.refs.MapHeader.show() }, 500)
...
// //   //   Animated.timing(this.state.height, { toValue: 200 }).start();
// //   // }
...
// //           ) 
// //         // () => console.log('scrolling', Animated.event) 
...
// //     }
// //     this.setState({ animating: true });
// //     Animated.timing(this.state.height, { toValue: 50 }).start();
// //   };
...
// //   render() {
// //     return (
// //     <Animated.View style={{width: width, height: this.getHeaderStyle()}}> 
// //       <LinearGradient
