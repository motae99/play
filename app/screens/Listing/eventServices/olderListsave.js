...
//  let documentSnapshots = await query.limit(3).get();
...
// const fetchMoreData = async function fetchMoreData(){
//  let documentSnapshots = query.startAfter(lastVisible).limit(limit).get();
//  let documentData = documentSnapshots.docs.map(document => {
//    return {
//      ...document.data(),
//      key: document.id,
    ...
    if (documentData && documentData.length > 0) {
      return (
        <View style={styles.container}>
          <FlatList
            data={documentData}
            renderItem={({ item }) => <Card item={item} toggleHeart={this.toggleHeart} navigation={this.props.navigation}/>}
...
//             style={styles.heart}
//           >
//             <Feather name="ios-heart-empty" size={35} color={"#ffff"} />
//           </Animatable.View>
//         </TouchableOpacity>
//       </View>
//     );
